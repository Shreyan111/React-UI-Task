        ...
        <>
            <div className="grid lg:grid-cols-2 lg:gap-32 bg-red-50">
                <div className="col-1 mb-20">
                    <div className='flex'>
                        <img
                            className="h-14 w-14 mt-10 ml-10 lg:ml-20"
                            src="https://tailwindui.com/img/logos/workflow-mark-indigo-500.svg"
                            alt="Workflow"
                        />
                        <h2 className='text-bold text-3xl mt-12 ml-3'>Slay<span className='font-bold'>Pay</span></h2>
                    </div>
                    <h2 className='ml-10 lg:ml-20 mt-4'>SlayPay is India's coolest payment card that you can customize the way you want. Use the SlayPay app to design your card with images, quotes, characters and more. Get revolutionary banking features with evolutionary security mechanisms.</h2>
                    <h1 className='font-bold mt-8 text-2xl ml-10 lg:ml-20'>Reach Us</h1>
                    <div className='flex'>
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-6 w-6 ml-10 lg:ml-20 mt-3" fill="none" viewBox="0 0 24 24" stroke="currentColor" stroke-width="2">
                            <path stroke-linecap="round" stroke-linejoin="round" d="M20 13V6a2 2 0 00-2-2H6a2 2 0 00-2 2v7m16 0v5a2 2 0 01-2 2H6a2 2 0 01-2-2v-5m16 0h-2.586a1 1 0 00-.707.293l-2.414 2.414a1 1 0 01-.707.293h-3.172a1 1 0 01-.707-.293l-2.414-2.414A1 1 0 006.586 13H4" />
                        </svg>
                        <h2 className='text-gray-600 ml-2 mt-3'>care@slaypay.app</h2>
                    </div>
                    <div className='flex'>
                        <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 ml-10 lg:ml-20 mt-3" viewBox="0 0 20 20" fill="currentColor">
                    ...
                    <h2 className='ml-10 lg:ml-20 font-bold mt-8 text-2xl'>Legal</h2>
                    <h3 className='ml-10 lg:ml-20 text-gray-600'>Terms & Conditions</h3>
                    <h3 className='ml-10 lg:ml-20 text-gray-600'>Privacy Policy</h3>
                    <h3 className='ml-10 lg:ml-20 text-gray-600'>Return & Refund</h3>
                </div>
                <div className="col-1 mb-20">
                    <div className='ml-32'>
